...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(/*! bootstrap */ 76)(__webpack_require__(/*! App/User */ 7));
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			Mime = __webpack_require__(/*! Common/Mime */ 54),
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (ko) {
		...
		var
			...
			_ = __webpack_require__(/*! _ */ 2),
			$ = __webpack_require__(/*! $ */ 12),
			Opentip = __webpack_require__(/*! Opentip */ 63),
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			_ = __webpack_require__(/*! _ */ 2),
			$ = __webpack_require__(/*! $ */ 12),
			SimplePace = __webpack_require__(/*! SimplePace */ 82),
			...
			AbstractApp = __webpack_require__(/*! App/Abstract */ 52)
		;
		...
		AppUser.prototype.deleteMessagesFromFolder = function (iDeleteType, sFromFolderFullNameRaw, aUidForRemove, bUseFolder)
		{
			...
			{
				kn.showScreenPopup(__webpack_require__(/*! View/Popup/FolderSystem */ 50), [nSetSystemFoldersNotification]);
			}
	...
	//		});
		...
		{
			kn.showScreenPopup(__webpack_require__(/*! View/Popup/WelcomePage */ 157), [sUrl]);
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			$ = __webpack_require__(/*! $ */ 12),
			ko = __webpack_require__(/*! ko */ 3),
			key = __webpack_require__(/*! key */ 17),
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			AbstractAjaxRemote = __webpack_require__(/*! Remote/AbstractAjax */ 65)
		;
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			AppStore = __webpack_require__(/*! Stores/App */ 71)
		;
			...
			if (Cache.getFolderInboxName() === sFolder && Utils.isNormal(sUidNext) && sUidNext !== '')
			{
				if (Utils.isArray(aNewMessages) && 0 < aNewMessages.length)
				{
					var
						...
						NotificationStore = __webpack_require__(/*! Stores/User/Notification */ 72)
					;
					...
					if (oMessagesDom)
					{
						...
						if (!oTextBody || !oTextBody[0])
						{
							...
							else if (Utils.isNormal(oData.Result.Plain) && '' !== oData.Result.Plain)
							{
								...
								if ((oMessage.isPgpSigned() || oMessage.isPgpEncrypted()) && __webpack_require__(/*! Stores/User/Pgp */ 27).capaOpenPGP())
								{
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			$ = __webpack_require__(/*! $ */ 12),
			ko = __webpack_require__(/*! ko */ 3),
			JSON = __webpack_require__(/*! JSON */ 80),
		...
		function ComposePopupView()
		{
			...
			this.sendCommand = Utils.createCommand(this, function () {
				...
				if (!this.emptyToError() && !this.attachmentsInErrorError() && !this.attachmentsInProcessError())
				{
					...
					if ('' === sSentFolder)
					{
						kn.showScreenPopup(__webpack_require__(/*! View/Popup/FolderSystem */ 50), [Enums.SetSystemFoldersNotification.Sent]);
					}
					else
					{
			...
			this.saveCommand = Utils.createCommand(this, function () {
				...
				{
					kn.showScreenPopup(__webpack_require__(/*! View/Popup/FolderSystem */ 50), [Enums.SetSystemFoldersNotification.Draft]);
				}
				else
				{
			...
			this.contactsCommand = Utils.createCommand(this, function () {
				...
				if (this.allowContacts)
				{
					...
					_.delay(function () {
						kn.showScreenPopup(__webpack_require__(/*! View/Popup/Contacts */ 74),
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			AbstractBoot = __webpack_require__(/*! Knoin/AbstractBoot */ 64)
		;
	...
	//		});
		...
		AbstractApp.prototype.bootstart = function ()
		{
			...
			ko.components.register('SaveTrigger', __webpack_require__(/*! Component/SaveTrigger */ 59));
			ko.components.register('Input', __webpack_require__(/*! Component/Input */ 56));
			ko.components.register('Select', __webpack_require__(/*! Component/Select */ 61));
			ko.components.register('TextArea', __webpack_require__(/*! Component/TextArea */ 62));
			ko.components.register('Radio', __webpack_require__(/*! Component/Radio */ 58));

			ko.components.register('x-script', __webpack_require__(/*! Component/Script */ 60));

			if (/**false && /**/Settings.settingsGet('MaterialDesign') && Globals.bAnimationSupported)
			{
				ko.components.register('Checkbox', __webpack_require__(/*! Component/MaterialDesign/Checkbox */ 57));
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			AbstracRadio = __webpack_require__(/*! Component/AbstracRadio */ 55)
		;
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			Enums = __webpack_require__(/*! Common/Enums */ 4),
			Audio = __webpack_require__(/*! Common/Audio */ 53),
		...
		function ContactsPopupView()
		{
			...
			this.newMessageCommand = Utils.createCommand(this, function () {
				...
				if (Utils.isNonEmptyArray(aE))
				{
					...
					kn.hideScreenPopup(__webpack_require__(/*! View/Popup/Contacts */ 74));
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		{
			__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/TwoFactorTest */ 155), [this.twoFactorTested]);
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		AbstractSystemDropDownUserView.prototype.addAccountClick = function ()
		{
			...
			{
				__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/Account */ 73));
			}
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		MessageModel.prototype.initUpdateByMessageJson = function (oJsonMessage)
		{
			...
			if (oJsonMessage && 'Object/Message' === oJsonMessage['@Object'])
			{
				...
				if (__webpack_require__(/*! Stores/User/Pgp */ 27).capaOpenPGP())
				{
	...
	//		}
		...
		{
			if (this.body && __webpack_require__(/*! Stores/User/Pgp */ 27).capaOpenPGP())
			{
				this.body.data('rl-pgp-verify-status', this.pgpSignedVerifyStatus());
				this.body.data('rl-pgp-verify-user', this.pgpSignedVerifyUser());
			}
	...
	(function () {
		...
		function LoginUserScreen()
		{
			AbstractScreen.call(this, 'login', [
				__webpack_require__(/*! View/User/Login */ 158)
			]);
		}
	...
	(function () {
		...
		function MailBoxUserScreen()
		{
			AbstractScreen.call(this, 'mailbox', [
				__webpack_require__(/*! View/User/MailBox/SystemDropDown */ 162),
				__webpack_require__(/*! View/User/MailBox/FolderList */ 159),
				__webpack_require__(/*! View/User/MailBox/MessageList */ 160),
				__webpack_require__(/*! View/User/MailBox/MessageView */ 161)
			]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			AbstractSettingsScreen = __webpack_require__(/*! Screen/AbstractSettings */ 66)
		;
		...
		function SettingsUserScreen()
		{
			AbstractSettingsScreen.call(this, [
				__webpack_require__(/*! View/User/Settings/SystemDropDown */ 165),
				__webpack_require__(/*! View/User/Settings/Menu */ 163),
				__webpack_require__(/*! View/User/Settings/Pane */ 164)
			]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		AccountsUserSettings.prototype.editAccount = function (oAccountItem)
		{
			...
			{
				__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/Account */ 73), [oAccountItem]);
			}
		};

		AccountsUserSettings.prototype.addNewIdentity = function ()
		{
			__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/Identity */ 75));
		};

		AccountsUserSettings.prototype.editIdentity = function (oIdentity)
		{
			__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/Identity */ 75), [oIdentity]);
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		{
			__webpack_require__(/*! Knoin/Knoin */ 5).showScreenPopup(__webpack_require__(/*! View/Popup/FolderSystem */ 50));
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		{
			kn.showScreenPopup(__webpack_require__(/*! View/Popup/NewOpenPgpKey */ 153));
		};
		...
		OpenPgpUserSettings.prototype.viewOpenPgpKey = function (oOpenPgpKey)
		{
			if (oOpenPgpKey)
			{
				kn.showScreenPopup(__webpack_require__(/*! View/Popup/ViewOpenPgpKey */ 156), [oOpenPgpKey]);
			}
		};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		var
			...
			PhotoSwipe = __webpack_require__(/*! PhotoSwipe */ 167),
			PhotoSwipeUI_Default = __webpack_require__(/*! PhotoSwipeUI_Default */ 168),
