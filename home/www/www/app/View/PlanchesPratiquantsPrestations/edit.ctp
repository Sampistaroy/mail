...
<?php echo $this->Form->create('PlanchesPratiquantsPrestation'); ?>
	<fieldset>
		<legend><?php echo __('Edit Planches Pratiquants Prestation'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('PlanchesPratiquantsPrestation.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('PlanchesPratiquantsPrestation.id'))); ?></li>
