...
class CalendargestionHelper extends AppHelper {
 ...
 */
 	public function display($date = null, $options=array(), $events=array(), $structure_id = null, $planches = null) {
				...
				$calendar.=  '&nbsp;&nbsp;&nbsp;&nbsp;'.$this->Html->link(
					...
					if(!empty($events[$list_day])) {
						...
						$calendar .= '<ul class="list-unstyled">';
								foreach($planches as $planch) {
									if($planch['Planch']['id']==$e){
										$calendar .= $this->Html->link(
						                    (int)(date_format(new DateTime($planch['Planch']['fin']),'H'))
						                    .'h:'.
						                    (int)(date_format(new DateTime($planch['Planch']['fin']),'H'))
						                    .'=>'.
						                    (int)(date_format(new DateTime($planch['Planch']['fin']),'H'))
						                    .'h:'.
						                    (int)(date_format(new DateTime($planch['Planch']['fin']),'i'))
						                    .'<br>'.
						                    $planch['Planch']['receptaclename'],
						                    array('controller' => 'planches_pratiquants_prestations', 'action' => 'view',$structure_id,$e),
