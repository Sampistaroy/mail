				...
				<?php dynamic_sidebar( 'social-magazine-primary-sidebar' ); ?>
					<?php else : ?>
						...
						<div class="social-magazine-theme-widget">
							<h3 class="widget-title"><?php _e( 'Recent Posts', 'social_magazine' ); ?></h3>
								<ul><?php wp_get_archives('type=postbypost&limit=5'); ?></ul>
						</div>
						
						<div class="social-magazine-theme-widget">
							<h3 class="widget-title"><?php _e( 'Tag Cloud', 'social_magazine' ); ?></h3>
								<?php wp_tag_cloud('smallest=10&largest=20&number=30&unit=px&format=flat&orderby=name'); ?>
						</div>
						
						<div class="social-magazine-theme-widget">
							<h3 class="widget-title"><?php _e( 'Pages', 'social_magazine' ); ?></h3>
								<ul><?php wp_list_pages( 'title_li=' ); ?></ul>
						</div>
						
						<div class="social-magazine-theme-widget">
							<h3 class="widget-title"><?php _e( 'Archives', 'social_magazine' ); ?></h3>
