...
?>
	...
	echo esc_html( get_theme_mod( 'main_paragraph_setting', 'Delete this or add an intro paragraph') );
	echo '</p>';
	}
	...
	echo '<p class="text-center">';
	echo esc_html( get_theme_mod( 'second_paragraph_setting', 'Delete this or add a second paragraph') );
	echo '</p>';
	}
